...
<div class="box bg-info bg-img" style="background-image: url(../images/gallery/bg-1.png)">
    <div class="box-body text-center">							
        ...
        <div class="max-w-500 mx-auto">
            <h2 class="text-white mb-20 font-weight-500">Best Employee OnlineShop,</h2>
            <p class="text-white-50 mb-10 font-size-20">Penjualan kamu meningkat, semester ini</p>
        </div>
    </div>
</div>
<div class="row">						
...
<div class="box">
    <div class="box-header">
        <h4 class="box-title align-items-start flex-column">
            New Arrivals
            <small class="subtitle">More than 200+ new members</small>
        </h4>
    </div>
    <div class="box-body">
